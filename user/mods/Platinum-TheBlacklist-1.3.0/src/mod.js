...
class TheBlacklistMod {
    ...
    initialiseMod(container) {
        ...
        ragfairConfig.dynamic.useTraderPriceForOffersIfHigher = advancedConfig_json_1.default.useTraderPriceForOffersIfHigher != null ? advancedConfig_json_1.default.useTraderPriceForOffersIfHigher : true;
        ...
        handbookItems.forEach(handbookItem => {
            ...
            if (config_json_1.default.useBalancedPricingForAllAmmo && this.isBulletOrShotgunShell(item)) {
        ...
        ragfairOfferGenerator.generateDynamicOffers().then(() => {
            ...
            if (config_json_1.default.useBalancedPricingForAllAmmo) {
    ...
    getFallbackGunPrice() {
        return advancedConfig_json_1.default.gunPriceFallback || 100000;
    }
    debug(message) {
